halleinApp.controller('RestaurantController', function ($scope, $location, $http) {
    ...
    $scope.config = {
        activeTab: 0,
        tabs: [
            {title: 'GENERAL', link: 'page#general', content: 'Public/Content/RestaurantGeneral.html',
                actions: [
            ...
            {title: 'OPENINGTIMES', link: 'page#times', content: 'Public/Content/RestaurantTimes.html',
                actions: [
                    {title: 'CLOSE', icon: 'close', route: '/'}
                ],},
            {title: 'DESIGN', link: 'page#design', content: 'Public/Content/RestaurantDesign.html',
                actions: [
                    {title: 'CLOSE', icon: 'close', route: '/'}
                ],}
        ]
